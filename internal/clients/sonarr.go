...
// GetDiskSpace fetches disk space information from Sonarr
func (c *SonarrClient) GetDiskSpace(ctx context.Context) ([]DiskSpace, error) {
	...
	log.Debug().Int("volumes", len(diskSpace)).Msg("Fetched disk space from Sonarr")
